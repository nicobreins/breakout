...
function drawUser(){
    user.style.left = currenPostion[0] + 'px';
    user.style.bottom = currenPostion[1] + 'px'
}
...
function moveUser(e){
    switch(e.key){
        case 'ArrowLeft':
            if(currenPostion[0] > 0){
                currenPostion[0] -= 10
                drawUser();
            }
            break;
        case 'ArrowRight':
            if(currenPostion[0] < boardWidth - blockWidth){
                currenPostion[0] += 10
                drawUser();
            }
            break;
...
function checkForCollisions(){
    ...
    if(
        (ballCurrentPostion[0] > currenPostion[0] && ballCurrentPostion[0] < currenPostion[0] + blockWidth) &&
        (ballCurrentPostion[1] > currenPostion[1] && ballCurrentPostion[1] < (currenPostion[1] + blockHeight))
        ){
            changeDirection();
    }
